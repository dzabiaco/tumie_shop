                ...
                <div class="collapse-body">
                  <div class="widget-menu-wrap">
                    <ul class="nav-menu">
                      ...
                      <li><router-link to="/account-login">Delivery Information</router-link></li>
                      <li><router-link to="/account-login">Privacy Policy</router-link></li>
                      <li><router-link to="/account-login">Terms & Conditions</router-link></li>
                      <li><router-link to="/contact">Contact Us</router-link></li>
                      <li><router-link to="/account-login">Log In Info</router-link></li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div class="widget-item nav-menu-item2">
              ...
              <div id="widgetId-2" class="collapse widget-collapse-body">
                <div class="collapse-body">
                  <div class="widget-menu-wrap">
                    <ul class="nav-menu">
                      <li><router-link to="/account-login">Gallery</router-link></li>
                      <li><router-link to="/shop">Brands</router-link></li>
                      <li><router-link to="/account-login">Gift Certificates</router-link></li>
                      <li><router-link to="/shop">Specials</router-link></li>
                      <li><router-link to="/account">My Account Us</router-link></li>
                      <li><router-link to="/about">About Us</router-link></li>
                    </ul>
                  </div>
                </div>
